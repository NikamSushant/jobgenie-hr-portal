...
export default function HRDashboard() {
  ...
  if (loading) return (
    <div style={{ background: '#0f0f0f', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16 }}>
      <img src={LOGO_SRC} alt="JobGenie AI" style={{ width: 72, height: 72, objectFit: 'contain', animation: 'pulse 1.5s infinite', filter: 'drop-shadow(0 8px 24px rgba(245,158,11,0.4))' }} />
